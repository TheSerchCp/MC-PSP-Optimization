...
#include <Minecraft/World/SimpleMeshChunk2.h>
...
public:
    ...
    void SpawnEnderman(float xx, float yy, float zz);
    void DestroyEnderman(int id);
    void DestroyAllEndermans();
    ...
    std::vector<Enderman*> mEndermans;
