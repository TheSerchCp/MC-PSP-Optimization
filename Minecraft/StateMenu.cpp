...
ControlInitMenu CSInit;
//Draw system independent
DrawInitMenu DSInitMenu;
...
void StateMenu::HandleEvents(StateManager* sManager)
{
    ...
    {
      CSInit.ControlSystemInit(sManager,mSystemMgr,mSoundMgr,selectPos,menuState,SplashNumber);
    }
    break;
    case 0://main menu
    {	
...
void StateMenu::Draw(StateManager* sManager)
{
    ...
    case -1://language menu
    {
        DSInitMenu.DrawSystemInitMenu(sManager,backSprite,buttonSprite,sbuttonSprite,selectPos,default_size);
    }
    break;
    case 0://main menu
    {
